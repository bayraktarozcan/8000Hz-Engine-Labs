...
![Version](https://img.shields.io/badge/v1.3.0-8B5CF6?style=flat-square)
...
- **Interactive filtering**: Real-time filtering by name (debounced), compatibility status, and game engine
...
- **OLED dark theme**: Custom dark theme with scan-line CRT overlay, dot-grid background, neon glow effects, glitch text animation, vignette overlay, and gradient border cards
...
We welcome contributions! See [`CONTRIBUTING.md`](CONTRIBUTING.md) and [`CODE_OF_CONDUCT.md`](CODE_OF_CONDUCT.md) for guidelines.
...
- **Etkileşimli filtreleme**: İsme (debounce'lu), uyumluluk durumuna ve oyun motoruna göre anlık filtreleme
...
- **OLED karanlık tema**: CRT tarama-çizgisi katmanı, nokta-grid arka plan, neon glow efektleri, glitch metin animasyonu, karartma (vignette) katmanı ve gradyan border kartlar
...
│   │   └── feature_request.md          # Özellik talebi şablonu
...
Katkılarınızı bekleriz! Rehber için [`CONTRIBUTING.md`](CONTRIBUTING.md) ve [`CODE_OF_CONDUCT.md`](CODE_OF_CONDUCT.md) dosyalarına bakın.

- [Hata Raporu Şablonu](.github/ISSUE_TEMPLATE/bug_report.md)
- [Özellik Talebi Şablonu](.github/ISSUE_TEMPLATE/feature_request.md)
- [Pull Request Şablonu](.github/PULL_REQUEST_TEMPLATE.md)
