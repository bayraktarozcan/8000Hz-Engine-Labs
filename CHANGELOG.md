...
| Sürüm | Hedef |
|---|---|---|
| 1.3.0 | Grafiksel polling rate test aracı (gerçek zamanlı), Community katkılı oyun veritabanı |
| 2.0.0 | Kullanıcı tema tercihleri, genişletilmiş diagnostik araç |
...
| Version | Goal |
|---|---|
| 1.3.0 | Graphical polling rate test tool (real-time), Community-contributed game database |
| 2.0.0 | User theme preferences, expanded diagnostic tool |
